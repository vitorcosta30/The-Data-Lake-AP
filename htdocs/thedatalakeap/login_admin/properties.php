...
<html lang="en">
  <head>
    ...
    <title>The Data Lake AP - Artigos</title>
 ...
 $consulta = "Select * From articles order by data DESC";
...
?>
 ...
 <!-- .$registo['combustivel']. -->
   ...
   echo '<a class="aa-properties-item-img" href="http://localhost/thedatalakeap/single_post.php?id='.$registo['ID'].'&submit=Ler+mais">';
   echo '<p><img src="carros/'.$registo['img'].'"width="480px" height="270px"></p>';
   echo '</a>';
  ...
  echo '<div class="aa-properties-about" style="height: 250px;">';
   ...
   echo '<p style="font-size:15px">Categoria: '.$registo['seccao'].'</p>';
   echo '</span>';
