...
<html lang="en">
  <head>
    ...
    <title>The Data Lake AP | Artigo inserido</title>
      ...
      <div class="aa-top-slider">
        ...
        <div class="aa-top-slider-single">
          ...
          <!-- Top slider content -->
                  ...
                  <h2 style="background-color: transparent;">Artigo foi criado!</h2>
                  <p>Agora esta disponivel para o publico</p>
          <!-- / Top slider content -->
            </div>  
          <!-- / Top slider content -->
...
?>
                                <select name="autor">
                                 ...
                                 <?php
                                  for ($i=0; $i <$nregistos; $i++)  {
   $registo = mysqli_fetch_assoc($result);   
                                echo ' <option value="'.$registo['autor'].'">'.$registo['autor'].'</option>';
                              }
?>
 </select>
                                Conteudo
            ...
            <div class="row">
              ...
              <div class="col-md-7">
                <div class="aa-about-us-right">
                  ...
                  <p>Este projeto trata-se de um projeto de formação tecnologica com objetivo em formar pessoas sobre assuntos como: </p>                  
                    ...
                    <div class="aa-single-service-content">
                      ...
                      <p></p>
                         ...
                         <?php 
                           ...
                           $code = $_POST['special_code'];
 
                           if (isset($_FILES['foto1'])){
                           //$extensao = strtolower(substr($_FILES['ffoto1']['name'], -4)); //pega a extensao do arquivo
                           //$foto1 = md5(time()) . $extensao; //define o nome do arquivo
                           $foto1= basename($_FILES["foto1"]["name"]);
                           $diretorio = "carros"; //define o diretorio para onde enviaremos o arquivo
                           move_uploaded_file($_FILES['foto1']['tmp_name'], "$diretorio/$foto1"); //efetua o upload
                            }
                           $ligax = mysqli_connect('localhost', 'root', '');
                           if (!$ligax)  {echo '<p> Erro: Falha na ligação.'; exit;};
                           mysqli_select_db($ligax, 'thedatalakeap');
                           $insere = " INSERT INTO articles ( img, titulo, desenv, seccao, autor, content, keywords, special_code ) VALUES ('".$foto1."' , '".$title."' , '".$desc."', '".$sec."', '".$aut."' , '".$cont."' , '".$key."', '".$code."' )";
