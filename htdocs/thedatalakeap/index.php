...
<html lang="en">
  <head>
    ...
    <!-- Favicon -->    <link rel="shortcut icon" href="img/logo.png" type="image/x-icon">
      ...
      <div class="aa-top-slider">
       ...
       <div class="aa-top-slider-single"> 
          ...
          <div class="aa-top-slider-content">
                  <h2 style="background-color: transparent;">Bem Vindo!</h2>
          <!-- / Top slider content -->
            </div>        
          <!-- / Top slider content -->
        </div>
      ...
      <div class="aa-advance-search-area">
        <div class="form">
         <div class="aa-advance-search-top">
            <div class="row">
                         <center><h2>Pesquisar Artigos</h2></center>
                         <br>
                         <br>
                         <br>
                         <form Nome="Formularios" action="pesquisar.php" method ="GET">
                              <div class="col-md-2">
             ...
             <div class="col-md-2">
              <div class="aa-single-advance-search">
                 ...
                 <input  class="aa-search-btn" type="submit" value="PESQUISAR">
    </div>
  </div>
